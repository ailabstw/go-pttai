...
func TestFriend4Account3(t *testing.T) {
	NNodes = 4
	isDebug := true
	...
	marshaled, _ = profileID2_3.MarshalText()
	bodyString = fmt.Sprintf(`{"id": "testID", "method": "account_getMasterOplogList", "params": ["%v", "", 0, 2]}`, string(marshaled))

	dataGetMasterLogList2_4 := &struct {
		Result []*pkgservice.MasterOplog `json:"result"`
	}{}

	testListCore(t2, bodyString, dataGetMasterLogList2_4, t, isDebug)
	assert.Equal(1, len(dataGetMasterLogList2_4.Result))

	marshaled, _ = profileID3_3.MarshalText()
	bodyString = fmt.Sprintf(`{"id": "testID", "method": "account_getMasterOplogList", "params": ["%v", "", 0, 2]}`, string(marshaled))

	dataGetMasterLogList3_4 := &struct {
		Result []*pkgservice.MasterOplog `json:"result"`
	}{}

	testListCore(t3, bodyString, dataGetMasterLogList3_4, t, isDebug)
	assert.Equal(1, len(dataGetMasterLogList3_4.Result))
	...
	dataShowURL2_5 := &pkgservice.BackendJoinURL{}
	testCore(t2, bodyString, dataShowURL2_5, t, isDebug)
	url2_5 := dataShowURL2_5.URL

	dataShowURL3_5 := &pkgservice.BackendJoinURL{}
	testCore(t3, bodyString, dataShowURL3_5, t, isDebug)
	url3_5 := dataShowURL3_5.URL
	...
	dataJoinFriend0_7_1 := &pkgservice.BackendJoinRequest{}
	testCore(t0, bodyString, dataJoinFriend0_7_1, t, isDebug)

	assert.Equal(me1_3.ID, dataJoinFriend0_7_1.CreatorID)
	assert.Equal(me1_1.NodeID, dataJoinFriend0_7_1.NodeID)

	// 0 join 2
	bodyString = fmt.Sprintf(`{"id": "testID", "method": "me_joinFriend", "params": ["%v"]}`, url2_5)

	dataJoinFriend0_7_2 := &pkgservice.BackendJoinRequest{}
	testCore(t0, bodyString, dataJoinFriend0_7_2, t, isDebug)

	assert.Equal(me2_3.ID, dataJoinFriend0_7_2.CreatorID)
	assert.Equal(me2_1.NodeID, dataJoinFriend0_7_2.NodeID)

	// 0 join 3
	bodyString = fmt.Sprintf(`{"id": "testID", "method": "me_joinFriend", "params": ["%v"]}`, url3_5)

	dataJoinFriend0_7_3 := &pkgservice.BackendJoinRequest{}
	testCore(t0, bodyString, dataJoinFriend0_7_3, t, isDebug)

	assert.Equal(me3_3.ID, dataJoinFriend0_7_3.CreatorID)
	assert.Equal(me3_1.NodeID, dataJoinFriend0_7_3.NodeID)

	// 1 join 2
	bodyString = fmt.Sprintf(`{"id": "testID", "method": "me_joinFriend", "params": ["%v"]}`, url2_5)

	dataJoinFriend1_7_2 := &pkgservice.BackendJoinRequest{}
	testCore(t1, bodyString, dataJoinFriend1_7_2, t, isDebug)

	assert.Equal(me2_3.ID, dataJoinFriend1_7_2.CreatorID)
	assert.Equal(me2_1.NodeID, dataJoinFriend1_7_2.NodeID)

	// 1 join 3
	bodyString = fmt.Sprintf(`{"id": "testID", "method": "me_joinFriend", "params": ["%v"]}`, url3_5)

	dataJoinFriend1_7_3 := &pkgservice.BackendJoinRequest{}
	testCore(t1, bodyString, dataJoinFriend1_7_3, t, isDebug)

	assert.Equal(me3_3.ID, dataJoinFriend1_7_3.CreatorID)
	assert.Equal(me3_1.NodeID, dataJoinFriend1_7_3.NodeID)

	// 2 join 1
	bodyString = fmt.Sprintf(`{"id": "testID", "method": "me_joinFriend", "params": ["%v"]}`, url1_5)

	dataJoinFriend2_7_1 := &pkgservice.BackendJoinRequest{}
	testCore(t2, bodyString, dataJoinFriend2_7_1, t, isDebug)

	assert.Equal(me1_3.ID, dataJoinFriend2_7_1.CreatorID)
	assert.Equal(me1_1.NodeID, dataJoinFriend2_7_1.NodeID)
	...
	dataJoinFriend3_7_1 := &pkgservice.BackendJoinRequest{}
	testCore(t3, bodyString, dataJoinFriend3_7_1, t, isDebug)

	assert.Equal(me1_3.ID, dataJoinFriend3_7_1.CreatorID)
	assert.Equal(me1_1.NodeID, dataJoinFriend3_7_1.NodeID)

	// 3 join 2
	bodyString = fmt.Sprintf(`{"id": "testID", "method": "me_joinFriend", "params": ["%v"]}`, url2_5)

	dataJoinFriend3_7_2 := &pkgservice.BackendJoinRequest{}
	testCore(t3, bodyString, dataJoinFriend3_7_2, t, isDebug)

	assert.Equal(me2_3.ID, dataJoinFriend3_7_2.CreatorID)
	assert.Equal(me2_1.NodeID, dataJoinFriend3_7_2.NodeID)
	...
	dataGetFriendRequests0_8_0 := &struct {
		Result []*pkgservice.BackendJoinRequest `json:"result"`
	}{}
	testListCore(t0, bodyString, dataGetFriendRequests0_8_0, t, isDebug)
	assert.Equal(0, len(dataGetFriendRequests0_8_0.Result))
	...
	assert.Equal(3, len(dataGetFriendList0_8.Result))
	friend0_8_0 := dataGetFriendList0_8.Result[0]
	friend0_8_1 := dataGetFriendList0_8.Result[1]
	friend0_8_2 := dataGetFriendList0_8.Result[2]

	var friend0_8 *friend.BackendGetFriend
	if reflect.DeepEqual(me1_1.ID, friend0_8_0.FriendID) {
		friend0_8 = friend0_8_0
	} else if reflect.DeepEqual(me1_1.ID, friend0_8_1.FriendID) {
		friend0_8 = friend0_8_1
	} else if reflect.DeepEqual(me1_1.ID, friend0_8_2.FriendID) {
		friend0_8 = friend0_8_2
	}
	...
	friend1_8_2 := dataGetFriendList1_8.Result[2]

	var friend1_8_0_0 *friend.BackendGetFriend
	if reflect.DeepEqual(me0_1.ID, friend1_8_0.FriendID) {
		friend1_8_0_0 = friend1_8_0
	} else if reflect.DeepEqual(me0_1.ID, friend1_8_1.FriendID) {
		friend1_8_0_0 = friend1_8_1
	} else if reflect.DeepEqual(me0_1.ID, friend1_8_2.FriendID) {
		friend1_8_0_0 = friend1_8_2
	}

	assert.Equal(types.StatusAlive, friend1_8_0_0.Status)
	assert.Equal(me0_1.ID, friend1_8_0_0.FriendID)
	assert.Equal(friend0_8.ID, friend1_8_0_0.ID)
	...
	assert.Equal(friend1_8_0_0.ID, friend1_9.ID)
	...
	dataGetMasterLogList2_13 := &struct {
		Result []*pkgservice.MasterOplog `json:"result"`
	}{}

	testListCore(t2, bodyString, dataGetMasterLogList2_13, t, isDebug)
	assert.Equal(1, len(dataGetMasterLogList2_13.Result))

	marshaled, _ = profileID3_3.MarshalText()
	bodyString = fmt.Sprintf(`{"id": "testID", "method": "account_getMasterOplogList", "params": ["%v", "", 0, 2]}`, string(marshaled))

	dataGetMasterLogList3_13 := &struct {
		Result []*pkgservice.MasterOplog `json:"result"`
	}{}

	testListCore(t3, bodyString, dataGetMasterLogList3_13, t, isDebug)
	assert.Equal(1, len(dataGetMasterLogList3_13.Result))
}
