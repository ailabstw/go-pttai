...
type ServiceContext struct {
	...
	NodeContext *pkgservice.ServiceContext
	Config      *NodeConfig
	Snapshot    []byte
}
...
// ServiceFunc returns a pkgservice.Service which can be used to boot a devp2p node
type ServiceFunc func(ctx *ServiceContext) (pkgservice.PttService, error)
