...
func TestFriendLeaveBoard5(t *testing.T) {
	NNodes = 2
	isDebug := true
	...
	assert.Equal(dataMemberOplogList0_25.Result, dataMemberOplogList1_25.Result)

	memberLog1_25_3 := dataMemberOplogList1_25.Result[3]
	...
	dataMemberList0_29 := &struct {
		Result []*pkgservice.Member `json:"result"`
	}{}
	testListCore(t0, bodyString, dataMemberList0_29, t, isDebug)
	assert.Equal(2, len(dataMemberList0_29.Result))
	member0_29_0 := dataMemberList0_29.Result[0]
	member0_29_1 := dataMemberList0_29.Result[1]
	var member0_29_me *pkgservice.Member
	var member0_29_other *pkgservice.Member
	if reflect.DeepEqual(member0_29_0.ID, me0_1.ID) {
		member0_29_me = member0_29_0
		member0_29_other = member0_29_1
	} else {
		member0_29_me = member0_29_1
		member0_29_other = member0_29_0
	}

	dataMemberList1_29 := &struct {
		Result []*pkgservice.Member `json:"result"`
	}{}
	testListCore(t1, bodyString, dataMemberList1_29, t, isDebug)
	assert.Equal(2, len(dataMemberList1_29.Result))
	member1_29_0 := dataMemberList1_29.Result[0]
	member1_29_1 := dataMemberList1_29.Result[1]
	var member1_29_me *pkgservice.Member
	var member1_29_other *pkgservice.Member
	if reflect.DeepEqual(member1_29_0.ID, me1_1.ID) {
		member1_29_me = member1_29_0
		member1_29_other = member1_29_1
	} else {
		member1_29_me = member1_29_1
		member1_29_other = member1_29_0
	}

	assert.Equal(member0_29_me, member1_29_other)
	assert.Equal(member0_29_other, member1_29_me)

	// 30. get my-member-log

	marshaled, _ = board1_13_1.ID.MarshalText()
	bodyString = fmt.Sprintf(`{"id": "testID", "method": "content_getMyMemberLog", "params": ["%v"]}`, string(marshaled))

	dataMyMemberLog1_30 := &pkgservice.BaseOplog{}

	testCore(t1, bodyString, dataMyMemberLog1_30, t, isDebug)
	assert.Equal(memberLog1_25_3.BaseOplog, dataMyMemberLog1_30)
	...
	// 33. get my-member-log

	marshaled, _ = board1_13_1.ID.MarshalText()
	bodyString = fmt.Sprintf(`{"id": "testID", "method": "content_getMyMemberLog", "params": ["%v"]}`, string(marshaled))

	dataMyMemberLog1_33 := &pkgservice.BaseOplog{}

	testCore(t1, bodyString, dataMyMemberLog1_33, t, isDebug)
	assert.Equal(memberLog1_25_3.BaseOplog, dataMyMemberLog1_33)
}
