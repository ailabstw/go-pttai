...
func TestArticleFriend6(t *testing.T) {
	NNodes = 2
	isDebug := true
	...
	// 43.3. update-article
	article43_3, _ := json.Marshal([]string{
		base64.StdEncoding.EncodeToString([]byte("測試171")),
		base64.StdEncoding.EncodeToString([]byte("測試172")),
		base64.StdEncoding.EncodeToString([]byte("測試173")),
		base64.StdEncoding.EncodeToString([]byte("測試174")),
		base64.StdEncoding.EncodeToString([]byte("測試175")),
		base64.StdEncoding.EncodeToString([]byte("測試176")),
		base64.StdEncoding.EncodeToString([]byte("測試177")),
		base64.StdEncoding.EncodeToString([]byte("測試178")),
		base64.StdEncoding.EncodeToString([]byte("測試179")),
	})

	marshaledID, _ = board1_10_0.ID.MarshalText()
	marshaledID2, _ = article1_43_1_1.ID.MarshalText()

	bodyString = fmt.Sprintf(`{"id": "testID", "method": "content_updateArticle", "params": ["%v", "%v", %v, []]}`, string(marshaledID), string(marshaledID2), string(article43_3))
	dataUpdateArticle1_43_3 := &content.BackendUpdateArticle{}
	testCore(t1, bodyString, dataUpdateArticle1_43_3, t, isDebug)
	assert.Equal(board1_10_0.ID, dataUpdateArticle1_43_3.BoardID)
	assert.Equal(article1_43_1_1.ID, dataUpdateArticle1_43_3.ArticleID)
	assert.Equal(2, dataUpdateArticle1_43_3.NBlock)

	// 43.4. get-article-block
	marshaledID2, _ = article1_43_1_1.ID.MarshalText()
	marshaledID3, _ = dataUpdateArticle1_43_3.ContentBlockID.MarshalText()

	bodyString = fmt.Sprintf(`{"id": "testID", "method": "content_getArticleBlockList", "params": ["%v", "%v", "%v", 0, 0, 10, 2]}`, string(marshaledID), string(marshaledID2), string(marshaledID3))

	dataGetArticleBlockList1_43_4 := &struct {
		Result []*content.ArticleBlock `json:"result"`
	}{}
	testListCore(t1, bodyString, dataGetArticleBlockList1_43_4, t, isDebug)
	assert.Equal(2, len(dataGetArticleBlockList1_43_4.Result))
	...
	assert.Equal(article43_4_0, dataGetArticleBlockList1_43_4.Result[0].Buf)
	assert.Equal(article43_4_1, dataGetArticleBlockList1_43_4.Result[1].Buf)
	...
	assert.Equal(2, len(dataGetArticleBlockList0_52.Result))

	assert.Equal(article42_0, dataGetArticleBlockList0_52.Result[0].Buf)
	assert.Equal(article42_1, dataGetArticleBlockList0_52.Result[1].Buf)

	dataGetArticleBlockList1_52 := &struct {
		Result []*content.ArticleBlock `json:"result"`
	}{}
	testListCore(t1, bodyString, dataGetArticleBlockList1_52, t, isDebug)
	assert.Equal(2, len(dataGetArticleBlockList1_52.Result))

	assert.Equal(article42_0, dataGetArticleBlockList1_52.Result[0].Buf)
	assert.Equal(article42_1, dataGetArticleBlockList1_52.Result[1].Buf)
	...
	assert.Equal(2, len(dataGetArticleBlockList0_53.Result))

	assert.Equal(article43_4_0, dataGetArticleBlockList0_53.Result[0].Buf)
	assert.Equal(article43_4_1, dataGetArticleBlockList0_53.Result[1].Buf)

	dataGetArticleBlockList1_53 := &struct {
		Result []*content.ArticleBlock `json:"result"`
	}{}
	testListCore(t1, bodyString, dataGetArticleBlockList1_53, t, isDebug)
	assert.Equal(2, len(dataGetArticleBlockList1_53.Result))

	assert.Equal(article43_4_0, dataGetArticleBlockList1_53.Result[0].Buf)
	assert.Equal(article43_4_1, dataGetArticleBlockList1_53.Result[1].Buf)
}
