...
func TestArticleFriend2(t *testing.T) {
	NNodes = 2
	isDebug := true
	...
	dataShowURL0_45 := &pkgservice.BackendJoinURL{}
	testCore(t0, bodyString, dataShowURL0_45, t, isDebug)
	url0_45 := dataShowURL0_45.URL

	// 47. join-friend
	bodyString = fmt.Sprintf(`{"id": "testID", "method": "me_joinFriend", "params": ["%v"]}`, url0_45)

	dataJoinFriend1_47 := &pkgservice.BackendJoinRequest{}
	testCore(t1, bodyString, dataJoinFriend1_47, t, isDebug)

	assert.Equal(me0_3.ID, dataJoinFriend1_47.CreatorID)
	assert.Equal(me0_1.NodeID, dataJoinFriend1_47.NodeID)
