...
func parseRequest(incomingMsg json.RawMessage) ([]rpcRequest, bool, Error) {
	...
	//log.Debug("parseRequest: after unmarshal", "incomingMsg", incomingMsg, "in", in)
	...
	//log.Debug("json.parseRequest: to check", "method", in.Method, "payload", in.Payload, "in", in)
	...
	//log.Debug("json.parseRequest: after check method", "method", in.Method, "payload", in.Payload, "in", in)
	// regular RPC call
	if len(in.Payload) == 0 {
...
func parseBatchRequest(incomingMsg json.RawMessage) ([]rpcRequest, bool, Error) {
	...
	for i, r := range in {
		...
		//log.Info("json.parseBatchRequest: to check", "method", r.Method, "payload", r.Payload, "id", id)
