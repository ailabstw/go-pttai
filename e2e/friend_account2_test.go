...
func TestFriendAccount2(t *testing.T) {
	NNodes = 2
	isDebug := true
	...
	dataShowURL0_15 := &pkgservice.BackendJoinURL{}
	testCore(t0, bodyString, dataShowURL0_15, t, isDebug)
	url0_15 := dataShowURL0_15.URL

	// 17. join-friend
	bodyString = fmt.Sprintf(`{"id": "testID", "method": "me_joinFriend", "params": ["%v"]}`, url0_15)

	dataJoinFriend1_17 := &pkgservice.BackendJoinRequest{}
	testCore(t1, bodyString, dataJoinFriend1_17, t, isDebug)

	assert.Equal(me0_3.ID, dataJoinFriend1_17.CreatorID)
	assert.Equal(me0_1.NodeID, dataJoinFriend1_17.NodeID)

	// 18. get account master oplog
	marshaled, _ = profileID0_3.MarshalText()
	bodyString = fmt.Sprintf(`{"id": "testID", "method": "account_getMasterOplogList", "params": ["%v", "", 0, 2]}`, string(marshaled))

	dataGetMasterLogList0_18 := &struct {
		Result []*pkgservice.MasterOplog `json:"result"`
	}{}

	testListCore(t0, bodyString, dataGetMasterLogList0_18, t, isDebug)
	assert.Equal(1, len(dataGetMasterLogList0_18.Result))

	marshaled, _ = profileID1_3.MarshalText()
	bodyString = fmt.Sprintf(`{"id": "testID", "method": "account_getMasterOplogList", "params": ["%v", "", 0, 2]}`, string(marshaled))

	dataGetMasterLogList1_18 := &struct {
		Result []*pkgservice.MasterOplog `json:"result"`
	}{}

	testListCore(t1, bodyString, dataGetMasterLogList1_18, t, isDebug)
	assert.Equal(1, len(dataGetMasterLogList1_18.Result))

	// 18. get account member oplog
	marshaled, _ = profileID0_3.MarshalText()
	bodyString = fmt.Sprintf(`{"id": "testID", "method": "account_getMemberOplogList", "params": ["%v", "", 0, 2]}`, string(marshaled))

	dataGetMemberLogList0_18 := &struct {
		Result []*pkgservice.MemberOplog `json:"result"`
	}{}

	testListCore(t0, bodyString, dataGetMemberLogList0_18, t, isDebug)
	assert.Equal(2, len(dataGetMemberLogList0_18.Result))

	marshaled, _ = profileID1_3.MarshalText()
	bodyString = fmt.Sprintf(`{"id": "testID", "method": "account_getMemberOplogList", "params": ["%v", "", 0, 2]}`, string(marshaled))

	dataGetMemberLogList1_18 := &struct {
		Result []*pkgservice.MemberOplog `json:"result"`
	}{}

	testListCore(t1, bodyString, dataGetMemberLogList1_18, t, isDebug)
	assert.Equal(2, len(dataGetMemberLogList1_18.Result))
}
