...
func TestFriendBoardTitle(t *testing.T) {
	NNodes = 2
	isDebug := true
	...
	board0_16_2 := &content.BackendGetBoard{}
	testCore(t0, bodyString, board0_16_2, t, isDebug)
	assert.Equal(title, board0_16_2.Title)

	board1_16_2 := &content.BackendGetBoard{}
	testCore(t1, bodyString, board1_16_2, t, isDebug)
	assert.Equal(title, board1_16_2.Title)
	...
	assert.Equal(3, len(dataBoardList0_13.Result))
	...
	defaultTitle0_13_1 := content.DefaultTitleTW(me1_1.ID, me0_1.ID, "")
	assert.Equal(defaultTitle0_13_1, board0_13_1.Title)
	...
	assert.Equal(3, len(dataBoardList1_13.Result))
	...
	defaultTitle1_13_0 := content.DefaultTitleTW(me1_1.ID, me1_1.ID, "")
	assert.Equal(defaultTitle1_13_0, board1_13_0.Title)
	...
	defaultTitle1_13_1 := content.DefaultTitleTW(me0_1.ID, me1_1.ID, "")
	assert.Equal(defaultTitle1_13_1, board1_13_1.Title)
	...
	testCore(t1, bodyString, dataGetTitle1_15, t, isDebug)
	...
	testCore(t1, bodyString, dataGetTitle1_17, t, isDebug)
