...
func TestFriendDeleteMember2(t *testing.T) {
	NNodes = 2
	isDebug := true
	...
	dataDeleteMember1_14 := false
	testCore(t0, bodyString, &dataDeleteMember1_14, t, isDebug)
	assert.Equal(true, dataDeleteMember1_14)
