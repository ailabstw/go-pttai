...
type Entry struct {
	Term             uint64    `protobuf:"varint,2,opt,name=Term" json:"t"`
	Index            uint64    `protobuf:"varint,3,opt,name=Index" json:"i"`
	Type             EntryType `protobuf:"varint,1,opt,name=Type,enum=raftpb.EntryType" json:"T"`
	Data             []byte    `protobuf:"bytes,4,opt,name=Data" json:"D,omitempty"`
...
type SnapshotMetadata struct {
	ConfState        ConfState `protobuf:"bytes,1,opt,name=conf_state,json=confState" json:"cs"`
	Index            uint64    `protobuf:"varint,2,opt,name=index" json:"i"`
	Term             uint64    `protobuf:"varint,3,opt,name=term" json:"t"`
	XXX_unrecognized []byte    `json:"-"`
}
...
type Snapshot struct {
	Data             []byte           `protobuf:"bytes,1,opt,name=data" json:"D,omitempty"`
	Metadata         SnapshotMetadata `protobuf:"bytes,2,opt,name=metadata" json:"M"`
	XXX_unrecognized []byte           `json:"-"`
}
...
type Message struct {
	Type             MessageType `protobuf:"varint,1,opt,name=type,enum=raftpb.MessageType" json:"T"`
	To               uint64      `protobuf:"varint,2,opt,name=to" json:"To"`
	From             uint64      `protobuf:"varint,3,opt,name=from" json:"Fm"`
	Term             uint64      `protobuf:"varint,4,opt,name=term" json:"t"`
	LogTerm          uint64      `protobuf:"varint,5,opt,name=logTerm" json:"lt"`
	Index            uint64      `protobuf:"varint,6,opt,name=index" json:"i"`
	Entries          []Entry     `protobuf:"bytes,7,rep,name=entries" json:"E,omitempty"`
	Commit           uint64      `protobuf:"varint,8,opt,name=commit" json:"C"`
	Snapshot         Snapshot    `protobuf:"bytes,9,opt,name=snapshot" json:"S"`
	Reject           bool        `protobuf:"varint,10,opt,name=reject" json:"R"`
	RejectHint       uint64      `protobuf:"varint,11,opt,name=rejectHint" json:"H"`
	Context          []byte      `protobuf:"bytes,12,opt,name=context" json:"c,omitempty"`
	XXX_unrecognized []byte      `json:"-"`
}
...
type HardState struct {
	Term             uint64 `protobuf:"varint,1,opt,name=term" json:"t"`
	Vote             uint64 `protobuf:"varint,2,opt,name=vote" json:"v"`
	Commit           uint64 `protobuf:"varint,3,opt,name=commit" json:"C"`
	XXX_unrecognized []byte `json:"-"`
}
...
type ConfState struct {
	Nodes            []uint64 `protobuf:"varint,1,rep,name=nodes" json:"n,omitempty"`
	Learners         []uint64 `protobuf:"varint,2,rep,name=learners" json:"l,omitempty"`
	Weights          []uint32 `protobuf:"varint,3,rep,name=weights" json:"w,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}
...
type ConfChange struct {
	...
	Type             ConfChangeType `protobuf:"varint,2,opt,name=Type,enum=raftpb.ConfChangeType" json:"T"`
	NodeID           uint64         `protobuf:"varint,3,opt,name=NodeID" json:"id"`
	Weight           uint32         `protobuf:"varint,4,opt,name=Weight" json:"w"`
	Context          []byte         `protobuf:"bytes,5,opt,name=Context" json:"c,omitempty"`
	XXX_unrecognized []byte         `json:"-"`
}
...
func (m *ConfChange) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	//log.Debug("ConfChange: Unmarshal: start")
	for iNdEx < l {
		preIndex := iNdEx
		var wire uint64
		for shift := uint(0); ; shift += 7 {
		...
		fieldNum := int32(wire >> 3)
		wireType := int(wire & 0x7)
		//log.Debug("ConfChange: Unmarshal", "fieldNum", fieldNum, "wireType", wireType)
		if wireType == 4 {
		...
		case 5:
			//log.Debug("ConfChange.Unmarshal: start Context", "wireType", wireType)
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Context", wireType)
			}
			var byteLen int
			...
			//log.Debug("ConfChange.Unmarshal: Content", "byteLen", byteLen)
			if byteLen < 0 {
				return ErrInvalidLengthRaft
			}
			postIndex := iNdEx + byteLen
			...
			m.Context = append(m.Context[:0], dAtA[iNdEx:postIndex]...)
			//log.Debug("ConfChange.Unmarshal: Context", "m.Context", m.Context, "postIndex", postIndex)
